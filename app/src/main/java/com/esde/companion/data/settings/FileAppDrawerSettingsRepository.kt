...
class FileAppDrawerSettingsRepository(
    ...
    override suspend fun setShowSearchBar(show: Boolean) {
        context.appDrawerSettingsDataStore.edit { it[SHOW_SEARCH_BAR_KEY] = show }
    }

    override fun observeShowSearchBar(): Flow<Boolean> {
        return context.appDrawerSettingsDataStore.data.map { it[SHOW_SEARCH_BAR_KEY] ?: true }
    }
    ...
    private companion object {
        ...
        val SHOW_SEARCH_BAR_KEY = booleanPreferencesKey("show_search_bar")
    }
}
