...
class FileGameMediaRepository(
    ...
    override suspend fun resolveMedia(systemShortName: String, romPath: String): GameMedia =
        withContext(Dispatchers.IO) {
            ...
            val baseRelativePath = GameMediaPathResolver.resolveBaseRelativePath(
            ...
            val filesByType = MediaType.entries
    ...
    private fun findExistingFile(type: MediaType, systemShortName: String, baseRelativePath: String): String? {
