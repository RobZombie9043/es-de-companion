 ...
 * tags/subtitle punctuation/"The"-prefix variants, and (see [isPartialMatch]) a narrow,
 * bounded word-subsequence check for titles that are otherwise identical but for a small
 * number of inserted words (e.g. "The Bugs Bunny Blowout" vs. the real RA title "The Bugs
 * Bunny Birthday Blowout"). A title that matches none of these is [TitleMatchResult.NoMatch],
 * to be resolved via a manual override rather than a guess.
 */
